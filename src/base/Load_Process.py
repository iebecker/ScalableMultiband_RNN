...
import BaseClass.Utils_06 as utils
from tqdm import tqdm
from sklearn.preprocessing import MinMaxScaler
import pickle
from Classifier.Model_51.CustomScalers import ParamPhysScaler
...
class Prep_Data():
    ...
    def __init__(self,
        ...
        # self.__func_aux_serialize = utils.aux_serialize
    ...
    def read_datasets(self):
        ...
        # print('train\n',Counter(self.data_train.Class))
        # print('val\n',Counter(self.data_val.Class))
        # print('test\n',Counter(self.data_test.Class))
        if self.default_split:
            ...
            # self.data_train = self.filter(self.data_train)
            # self.data_test = self.filter(self.data_test)
            # self.data_val = self.filter(self.data_val)
    ...
    def __process_shuffle_util(self, dict):
        ...
        # Get the keys
        keys = list(dict.keys())
        # Get integet from 0 to the number of elements-1
    ...
    def fit_scalers(self):
        ...
        for var in self.params_phys:
            ...
            # self.scalers[var] = MinMaxScaler((0.1,1.1))
